...
class WebTests(unittest.TestCase):
    ...
    def test_movie_audio_packaging_page_is_wired(self) -> None:
        ...
        self.assertIn("width: TABLE_WIDTHS.anchor", widths_js)
    ...
    def test_normalize_lab_css_exposes_shell_layout_and_rhythm_contracts(self) -> None:
        ...
        self.assertIn('--lab-table-select-column-width: 28px;', css_source)
        ...
        self.assertIn('.lab-scan-table col.lab-col-select', css_source)
    ...
    def test_normalize_lab_table_declares_fixed_select_column_contract(self) -> None:
        ...
        self.assertIn("anchor: '24%'", widths_js)
        self.assertIn("anchorWide: '30%'", widths_js)
        ...
        self.assertIn("select: 'var(--lab-table-select-column-width)'", widths_js)
        self.assertIn("width: TABLE_WIDTHS.anchorWide", widths_js)
        self.assertIn("width: TABLE_WIDTHS.anchor", widths_js)
