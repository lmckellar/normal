...
- have the most obvious, clear and consistent naming convention of `Title (Year)`, unless needed to differentiate duplicates or alternate versions, whereby a logical differiating token will be appended to the end of the name
