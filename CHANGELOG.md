...
- `/normalize-lab` now exposes linked change reasons and warning messages in the detail pane, and row selection updates the active detail view directly so review cases are easier to inspect without exporting first.
